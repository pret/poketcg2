...
.rule_coords
	; x, y
	db  3,  8 ; SPECIAL_RULE_CHLOROPHYLL
	db  5,  8 ; SPECIAL_RULE_THUNDER_CHARGE
	db  7,  8 ; SPECIAL_RULE_FLAME_ARMOR
	db  9,  7 ; SPECIAL_RULE_SMALL_BENCH
	db 11,  7 ; SPECIAL_RULE_RUNNING_WATER
	db  3, 18 ; SPECIAL_RULE_EARTH_POWER
	db  5, 17 ; SPECIAL_RULE_LOW_RESISTANCE
	db  7, 17 ; SPECIAL_RULE_ENERGY_RETURN
	db  9, 17 ; SPECIAL_RULE_TOUGH_ESCAPE
	db 11, 18 ; SPECIAL_RULE_BLACK_HOLE
