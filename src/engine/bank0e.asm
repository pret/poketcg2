SECTION "Bank e@41fe", ROMX[$41fe], BANK[$e]
...
SECTION "Bank e@4c00", ROMX[$4c00], BANK[$e]
...
SECTION "Bank e@4dbf", ROMX[$4dbf], BANK[$e]
...
SECTION "Bank e@514f", ROMX[$514f], BANK[$e]
...
.asm_3a5ec
	...
	inc hl
	ld a, [hld]
	cp HIGH(CHARIZARD_LV76)
	jr nz, .asm_3a5f7
	ld a, [hl]
	cp LOW(CHARIZARD_LV76)
.asm_3a5f7
