...
ReceiveCardTable:
	receivecard GRS_MEWTWO, PromotionalGRMewtwoLv35Text, PromotionalGRMewtwoText, ReceivedPromotionalGRMewtwoText, FALSE, 0
	receivecard ARCANINE_LV34, PromotionalArcanineLv34Text, PromotionalArcanineLv34Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard ELECTABUZZ_LV20, PromotionalElectabuzzLv20Text, PromotionalElectabuzzLv20Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard DRAGONITE_LV41, PromotionalDragoniteLv41Text, PromotionalDragoniteLv41Text, ReceivedLegendaryCardText_2, TRUE, ReceivedPromotionalCardText_2
	receivecard DRAGONITE_LV43, PromotionalDragoniteLv43Text, PromotionalDragoniteLv43Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard COOL_PORYGON, PromotionalCoolPorygonLv15Text, PromotionalCoolPorygonText, ReceivedPromotionalCoolPorygonText, FALSE, 0
	receivecard BLASTOISE_ALT_LV52, PromotionalBlastoiseLv52Text, PromotionalBlastoiseLv52Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard FARFETCHD_ALT_LV20, PromotionalFarfetchdLv20Text, PromotionalFarfetchdLv20Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard KANGASKHAN_LV38, PromotionalKangaskhanLv38Text, PromotionalKangaskhanLv38Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard POTION_ENERGY, 0, NotPromotionalPotionEnergyText, ReceivedNotPromotionalPotionEnergyText, FALSE, 0
	receivecard HUNGRY_SNORLAX, PromotionalHungrySnorlaxLv50Text, PromotionalHungrySnorlaxText, ReceivedPromotionalHungrySnorlaxText, FALSE, 0
	receivecard MAGIKARP_LV10, PromotionalMagikarpLv10Text, PromotionalMagikarpLv10Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard ZAPDOS_LV68, PromotionalZapdosLv68Text, PromotionalZapdosLv68Text, ReceivedLegendaryCardText_2, TRUE, ReceivedPromotionalCardText_2
	receivecard FLYING_PIKACHU_LV12, PromotionalFlyingPikachuLv12Text, PromotionalFlyingPikachuText, ReceivedPromotionalFlyingPikachuText_2, FALSE, 0
	receivecard FLYING_PIKACHU_ALT_LV12, PromotionalFlyingPikachuLv12Text, PromotionalFlyingPikachuText, ReceivedPromotionalFlyingPikachuText_2, FALSE, 0
	receivecard DUGTRIO_LV40, PromotionalDugtrioLv40Text, PromotionalDugtrioLv40Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard SUPER_ENERGY_RETRIEVAL, PromotionalSuperEnergyRetrievalText, PromotionalSuperEnergyRetrievalText, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard DIGLETT_LV16, PromotionalDiglettLv16Text, PromotionalDiglettLv16Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard TOGEPI, PromotionalTogepiLv8Text, PromotionalTogepiLv8Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard SURFING_PIKACHU_LV13, PromotionalSurfingPikachuLv13Text, PromotionalSurfingPikachuText, ReceivedPromotionalSurfingPikachuText_2, FALSE, 0
	receivecard SURFING_PIKACHU_ALT_LV13, PromotionalSurfingPikachuLv13Text, PromotionalSurfingPikachuText, ReceivedPromotionalSurfingPikachuText_2, FALSE, 0
	receivecard MEOWTH_LV14, PromotionalMeowthLv14Text, PromotionalMeowthLv14Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard COMPUTER_ERROR, PromotionalComputerErrorText, PromotionalComputerErrorText, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard PIKACHU_LV13, PromotionalPikachuLv13Text, PromotionalPikachuLv13Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard PIKACHU_LV16, PromotionalPikachuLv16Text, PromotionalPikachuLv16Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard PIKACHU_ALT_LV16, PromotionalPikachuLv16Text, PromotionalPikachuLv16Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MOLTRES_LV40, PromotionalMoltresLv40Text, PromotionalMoltresLv40Text, ReceivedLegendaryCardText_2, TRUE, ReceivedPromotionalCardText_2
	receivecard VENUSAUR_ALT_LV67, PromotionalVenusaurLv67Text, PromotionalVenusaurLv67Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard ARTICUNO_LV37, PromotionalArticunoLv37Text, PromotionalArticunoLv37Text, ReceivedLegendaryCardText_2, TRUE, ReceivedPromotionalCardText_2
	receivecard JIGGLYPUFF_LV12, PromotionalJigglypuffLv12Text, PromotionalJigglypuffLv12Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard GOOP_GAS_ATTACK, 0, 0, ReceivedCardText_4, FALSE, 0
	receivecard BILLS_COMPUTER, PromotionalBillsComputerText, PromotionalBillsComputerText, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MARILL, PromotionalMarillLv17Text, PromotionalMarillLv17Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MANKEY_ALT_LV7, PromotionalMankeyLv7Text, PromotionalMankeyLv7Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MEW_LV8, PromotionalMewLv8Text, PromotionalMewLv8Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MEWTWO_LV30, PromotionalMewtwoLv30Text, PromotionalMewtwoLv30Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MEWTWO_ALT_LV60, PromotionalMewtwoLv60Text, PromotionalMewtwoLv60Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard MEWTWO_LV60, PromotionalMewtwoLv60Text, PromotionalMewtwoLv60Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard SLOWPOKE_LV9, PromotionalSlowpokeLv9Text, PromotionalSlowpokeLv9Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard CHARIZARD_ALT_LV76, PromotionalCharizardLv76Text, PromotionalCharizardLv76Text, ReceivedPromotionalCardText_2, FALSE, 0
	receivecard ROCKETS_SNEAK_ATTACK, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_ARBOK, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_PRIMEAPE, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_FEAROW, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_MACHAMP, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_DRAGONITE, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_BLASTOISE, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_NINETALES, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_GYARADOS, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_RAPIDASH, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_GLOOM, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_MACHOKE, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_GOLDUCK, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_GOLBAT, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_JOLTEON, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_VAPOREON, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_STARMIE, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_HYPNO, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_DUGTRIO, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_DRAGONAIR, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_FLAREON, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_ALAKAZAM, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_IVYSAUR, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_VENUSAUR, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_MUK, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_PERSIAN_LV28, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_PERSIAN_ALT_LV28, PromotionalDarkPersianLv28Text, PromotionalDarkPersianLv28Text, ReceivedPromotionalCardText_3, FALSE, 0
	receivecard DARK_WEEZING, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_ELECTRODE, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_KADABRA, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_RAICHU, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_VILEPLUME, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_CHARIZARD, 0, 0, ReceivedCardText_3, FALSE, 0
	receivecard DARK_MAGNETON, 0, 0, ReceivedCardText_3, FALSE, 0
	dw $ffff
