...
; Box message id's
	const_def
	const BOXMSG_PLAYERS_TURN   ; $0
	const BOXMSG_OPPONENTS_TURN ; $1
	const BOXMSG_BETWEEN_TURNS  ; $2
	const BOXMSG_DECISION       ; $3
	const BOXMSG_BENCH_POKEMON  ; $4
	const BOXMSG_ARENA_POKEMON  ; $5
	const BOXMSG_COIN_TOSS      ; $6
