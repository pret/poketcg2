...
; !TYPE_PKMN
rsunion
DEF CARD_DATA_EFFECT_COMMANDS     RW ; $0a
DEF CARD_DATA_NONPKMN_DESCRIPTION RW 2 ; $0c
...
; TYPE_PKMN
rsnextu
DEF CARD_DATA_HP          RB ; $0a
DEF CARD_DATA_STAGE       RB ; $0b
DEF CARD_DATA_PREEVO_NAME RW ; $0c
...
; TYPE_ENERGY_* -> generic type
DEF ENERGY_TYPE_MASK EQU %111
...
DEF PRESENT_PACK EQU const_value ; $07
...
DEF BOOSTERS_PRESENT_START         EQU const_value ; $8
	const BOOSTER_PRESENT_10_ENERGY            ; $8
DEF BOOSTERS_PRESENT_REGULAR_START EQU const_value ; $9
...
DEF NUM_BOOSTERS_PRESENT_REGULAR   EQU const_value - BOOSTERS_PRESENT_REGULAR_START ; 4
