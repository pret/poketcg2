...
DUELVARS_CARD_LOCATIONS                   EQU $00 ; EQUS "LOW(wPlayerCardLocations)"               ; 00
DUELVARS_PRIZE_CARDS                      EQUS "LOW(wPlayerPrizeCards)"                  ; 3c
DUELVARS_HAND                             EQU $42 ; EQUS "LOW(wPlayerHand)"                        ; 42
DUELVARS_DECK_CARDS                       EQU $7e ; EQUS "LOW(wPlayerDeckCards)"                   ; 7e
DUELVARS_NUMBER_OF_CARDS_NOT_IN_DECK      EQU $ba ; EQUS "LOW(wPlayerNumberOfCardsNotInDeck)"      ; ba
DUELVARS_ARENA_CARD                       EQU $bb ; EQUS "LOW(wPlayerArenaCard)"                   ; bb
DUELVARS_BENCH                            EQUS "LOW(wPlayerBench)"                       ; bc
DUELVARS_ARENA_CARD_FLAGS                 EQU $c2 ; EQUS "LOW(wPlayerArenaCardFlags)"              ; c2
DUELVARS_ARENA_CARD_HP                    EQU $c8 ; EQUS "LOW(wPlayerArenaCardHP)"                 ; c8
...
DUELVARS_ARENA_CARD_STAGE                 EQU $ce ; EQUS "LOW(wPlayerArenaCardStage)"              ; ce
...
DUELVARS_ARENA_CARD_CHANGED_TYPE          EQU $d4 ; EQUS "LOW(wPlayerArenaCardChangedType)"        ; d4
...
DUELVARS_ARENA_CARD_ATTACHED_DEFENDER     EQU $da ; EQUS "LOW(wPlayerArenaCardAttachedDefender)"   ; da
...
DUELVARS_ARENA_CARD_ATTACHED_PLUSPOWER    EQU $e0 ; EQUS "LOW(wPlayerArenaCardAttachedPluspower)"  ; e0
...
DUELVARS_ARENA_CARD_SUBSTATUS1            EQU $ed ; EQUS "LOW(wPlayerArenaCardSubstatus1)"         ; e7
DUELVARS_ARENA_CARD_SUBSTATUS2            EQU $ee ; EQUS "LOW(wPlayerArenaCardSubstatus2)"         ; e8
DUELVARS_ARENA_CARD_CHANGED_WEAKNESS      EQU $ef ; EQUS "LOW(wPlayerArenaCardChangedWeakness)"    ; e9
DUELVARS_ARENA_CARD_CHANGED_RESISTANCE    EQU $f0 ; EQUS "LOW(wPlayerArenaCardChangedResistance)"  ; ea
DUELVARS_ARENA_CARD_SUBSTATUS3            EQU $f1 ; EQUS "LOW(wPlayerArenaCardSubstatus3)"         ; eb
DUELVARS_PRIZES                           EQU $f2 ; EQUS "LOW(wPlayerPrizes)"                      ; ec
DUELVARS_NUMBER_OF_CARDS_IN_DISCARD_PILE  EQU $f3 ; EQUS "LOW(wPlayerNumberOfCardsInDiscardPile)"  ; ed
DUELVARS_NUMBER_OF_CARDS_IN_HAND          EQU $f4 ; EQUS "LOW(wPlayerNumberOfCardsInHand)"         ; ee
DUELVARS_NUMBER_OF_POKEMON_IN_PLAY_AREA   EQU $f5 ; EQUS "LOW(wPlayerNumberOfPokemonInPlayArea)"   ; ef
DUELVARS_ARENA_CARD_STATUS                EQU $ec ; EQUS "LOW(wPlayerArenaCardStatus)"             ; f0
DUELVARS_DUELIST_TYPE                     EQU $f6 ; EQUS "LOW(wPlayerDuelistType)"                 ; f1
DUELVARS_ARENA_CARD_DISABLED_ATTACK_INDEX EQU $f7 ; EQUS "LOW(wPlayerArenaCardDisabledAttackIndex)" ; f2
