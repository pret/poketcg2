...
; (see src\data\attack_animations.asm)
	...
	const ATK_ANIM_ENERGY_TRAINER_DAMAGE          ; $8f
	const ATK_ANIM_OWN_SLEEP                      ; $90
	const ATK_ANIM_STARE_BENCH                    ; $91
	const ATK_ANIM_OWN_POISON                     ; $92
	const ATK_ANIM_THUNDER_WAVE_BENCH             ; $93
	...
	const ATK_ANIM_SHORT_CIRCUIT_BENCH            ; $9b
	...
	const ATK_ANIM_POLLEN_STENCH_CONFUSION        ; $bb
	const ATK_ANIM_POLLEN_STENCH_OWN_CONFUSION    ; $bc
	...
	const ATK_ANIM_SUPERCONDUCTIVITY_BENCH        ; $dc
	...
	const ATK_ANIM_FOCUS_BLAST_BENCH              ; $e3
	const ATK_ANIM_UNUSED_E4                      ; $e4
	const ATK_ANIM_FADE_TO_BLACK                  ; $e5
	const ATK_ANIM_BONE_TOSS_BENCH                ; $e6
	...
	const ATK_ANIM_FOCUSED_ONE_SHOT_FAILED        ; $ed
