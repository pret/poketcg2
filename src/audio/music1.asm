...
Music1_SFXPriorities:
	...
	db $0a ; SFX_SLOT_REEL
	db $0a ; SFX_BLACKBOX_INSERT
	db $0a ; SFX_BLACKBOX_INSERTED
	db $0a ; SFX_BLACKBOX_TRANSMITTED
	db $0a ; SFX_82
	db $0a ; SFX_POD_DOORS
	db $0a ; SFX_PITFALL
	...
	db $0a ; SFX_GR_SHIP_HATCH_CLOSE
	db $0a ; SFX_GR_SHIP_HATCH_OPEN
	db $0a ; SFX_GR_SHIP_BEAM
	...
	db $0a ; SFX_DARK_SONG
	db $0a ; SFX_INTRO_ORB_TCG2
	db $0a ; SFX_INTRO_TITLE_FLIP_UP
	db $0a ; SFX_INTRO_SUBTITLE_WOBBLE_IN
